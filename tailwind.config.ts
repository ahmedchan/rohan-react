   ...
   theme: {
      extend: {
         ...
         colors: {
            ...
            "input-disabled-color": "hsl(var(--input-disabled-color) / <alpha-value>)",
         ...
         animation: {
            ...
            confirmDialogShow: "confirmDialogShow 400ms cubic-bezier(0.16, 1, 0.3, 1)",
            confirmDialogHide: "confirmDialogHide 400ms cubic-bezier(0.16, 1, 0.3, 1)"
         }
      }
   },
   variants: {

...
const Button = (_ref2, ref) => {
  ...
  }, children), loading && /*#__PURE__*/React__default.createElement(Spinner, {
    position: "absolute",
    size: "sm"
  }));
};
...
const Confirm = _ref => {
  ...
  const [internalOpen, setInternalOpen] = React.useState(hasDefaultOpen ? defaultOpen : false);
  ...
  return /*#__PURE__*/React__default.createElement(AlertDialog.Root, {
    open: isOpen,
    onOpenChange: onOpenChange
  }, children, /*#__PURE__*/React__default.createElement(AlertDialog.Portal, null, /*#__PURE__*/React__default.createElement("div", {
    className: "fixed inset-0 overflow-y-auto z-30 h-screen"
  }, /*#__PURE__*/React__default.createElement(AlertDialog.Overlay, {
    asChild: true
  ...
  }, /*#__PURE__*/React__default.createElement(Backdrop$1, null))), /*#__PURE__*/React__default.createElement(framerMotion.AnimatePresence, null, /*#__PURE__*/React__default.createElement(ConfirmContent, {
    title: title,
    isOpen: isOpen,
...
const ConfirmTitle = _ref2 => {
  ...
  return /*#__PURE__*/React__default.createElement(AlertDialog.Trigger, {
    asChild: true
  }, children);
};
const ConfirmContent = _ref3 => {
  ...
  return isOpen ? ( /*#__PURE__*/React__default.createElement(framerMotion.motion.div, {
  ...
  }, /*#__PURE__*/React__default.createElement(AlertDialog.Content, {
  ...
  }, /*#__PURE__*/React__default.createElement(AlertDialog.Title, {
    className: "text-primary-tex mb-3 m-0 text-[18px] font-medium"
  }, title), description ? ( /*#__PURE__*/React__default.createElement(AlertDialog.Description, {
  ...
  }, asyncStatus ? null : ( /*#__PURE__*/React__default.createElement(AlertDialog.Cancel, {
    asChild: true
    ...
    className: "px-4"
  }, cancelLabel)))), isControlled ? ( /*#__PURE__*/React__default.createElement(Button$1, Object.assign({
    type: "button",
    rounded: true,
    loading: asyncStatus,
    ...
    onClick: onConfirm
  }, confirmProps), /*#__PURE__*/React__default.createElement("span", {
    className: "px-4"
  }, confirmLabel))) : ( /*#__PURE__*/React__default.createElement(AlertDialog.Action, {
    asChild: true
  }, /*#__PURE__*/React__default.createElement(Button$1, Object.assign({
    type: "button",
    rounded: true,
    variant: confirmVariant,
    onClick: onConfirm
  }, cancelProps), /*#__PURE__*/React__default.createElement("span", {
    className: "px-4"
  }, confirmLabel)))))))) : null;
};
...
const Avatar = (_ref, ref) => {
  ...
  const [isImageLoading, setIsImageLoading] = React.useState("idle");
  ...
  return /*#__PURE__*/React__default.createElement(RadixAvatar.Root, Object.assign({
    style: {
      width: width + "px",
      height: height + "px"
    },
    ...
    ref: ref
  }, props), /*#__PURE__*/React__default.createElement(RadixAvatar.Image, {
    ...
    height: height,
    loading: "lazy"
  }), isImageLoading === "loading" && /*#__PURE__*/React__default.createElement(Spinner, {
    size: "xs",
    variant: "primary"
  }), isImageLoading === "error" && ( /*#__PURE__*/React__default.createElement(RadixAvatar.Fallback, {
...
const AvatarGroup = props => {
  ...
  }, props), /*#__PURE__*/React__default.createElement("span", null, "+", restItemCount))) : null);
};
...
const CloseButton = (_ref, ref) => {
  ...
  return /*#__PURE__*/React__default.createElement(IconButton$1, Object.assign({
    ref: ref,
    type: "button",
    variant: "default",
...
const ModalTrigger = _ref2 => {
  ...
  return /*#__PURE__*/React__default.createElement(Dialog.Trigger, {
    asChild: asChild
  }, children);
};
const ModalContent = _ref3 => {
  ...
  return /*#__PURE__*/React__default.createElement(framerMotion.AnimatePresence, null, open ? ( /*#__PURE__*/React__default.createElement(Dialog.Portal, {
    forceMount: true
  }, /*#__PURE__*/React__default.createElement("div", {
    className: "fixed inset-0 overflow-y-auto z-30 h-screen"
  ...
  }, /*#__PURE__*/React__default.createElement(Backdrop$1, null))), /*#__PURE__*/React__default.createElement(framerMotion.motion.div, {
    key: `modal-${new Date().toDateString()}`,
    initial: {
      opacity: 0,
      scale: 0.9
    ...
    className: `flex w-full h-full items-center justify-center`
  }, /*#__PURE__*/React__default.createElement(Dialog.Content, Object.assign({
    forceMount: true,
    onEscapeKeyDown: event => event.preventDefault(),
  ...
  }, props), closable && ( /*#__PURE__*/React__default.createElement(Dialog.Close, {
    asChild: true
  }, /*#__PURE__*/React__default.createElement("div", {
    className: "absolute z-1 ltr:right-4 rtl:left-4 top-4"
  }, /*#__PURE__*/React__default.createElement(CloseButton$1, null)))), title && ( /*#__PURE__*/React__default.createElement("header", {
  ...
  }, title), description && ( /*#__PURE__*/React__default.createElement(Dialog.Description, {
    className: `text-sm text-secondary-text mt-1`
  }, description)))), /*#__PURE__*/React__default.createElement("section", {
...
const ModalClose = _ref4 => {
  ...
  return /*#__PURE__*/React__default.createElement(Dialog.Close, {
    asChild: true,
    "aria-label": "close"
  }, children);
};
...
const Divider = _ref => {
  ...
  return /*#__PURE__*/React__default.createElement(Separator.Root, {
    decorative: true,
...
const ModalContent$1 = _ref3 => {
  ...
  return /*#__PURE__*/React__default.createElement(framerMotion.AnimatePresence, null, open ? ( /*#__PURE__*/React__default.createElement(Dialog.Portal, {
    ...
    className: `text-sm text-secondary-text mt-1`
  }, description)))), /*#__PURE__*/React__default.createElement("article", {
...
const Scrollable = _ref => {
  ...
  return /*#__PURE__*/React__default.createElement(ScrollArea.Root, {
    className: "ScrollAreaRoot"
  }, /*#__PURE__*/React__default.createElement(ScrollArea.Viewport, {
    className: `h-full w-full rounded-inhiert`
  }, children), /*#__PURE__*/React__default.createElement(ScrollArea.Scrollbar, {
    className: "ScrollAreaScrollbar",
    orientation: "vertical"
  }, /*#__PURE__*/React__default.createElement(ScrollArea.Thumb, {
    className: "ScrollAreaThumb"
  })), /*#__PURE__*/React__default.createElement(ScrollArea.Scrollbar, {
    className: "ScrollAreaScrollbar",
    orientation: "horizontal"
  }, /*#__PURE__*/React__default.createElement(ScrollArea.Thumb, {
    className: "ScrollAreaThumb"
  })), /*#__PURE__*/React__default.createElement(ScrollArea.Corner, {
...
const Dropdown = _ref => {
  ...
  return /*#__PURE__*/React__default.createElement(RadixDropdownMenu.Root, {
    dir: dir,
    modal: modal,
    open: isOpen,
    onOpenChange: onOpenChange
...
const DropdownTrigger = _ref2 => {
  ...
  return /*#__PURE__*/React__default.createElement(RadixDropdownMenu.Trigger, Object.assign({
    asChild: true,
    disabled: disabled
  }, props), children);
};
const DropdownHeader = _ref3 => {
  ...
  }, title)) : null, closeable ? /*#__PURE__*/React__default.createElement(CloseButton$1, {
...
const DropdownMenu = _ref4 => {
  ...
  return /*#__PURE__*/React__default.createElement(RadixDropdownMenu.Portal, null, /*#__PURE__*/React__default.createElement(RadixDropdownMenu.Content, {
    asChild: true,
    loop: true,
    side: side,
  ...
  }, /*#__PURE__*/React__default.createElement(framerMotion.motion.div, Object.assign({
  ...
  }, props), title ? ( /*#__PURE__*/React__default.createElement(DropdownHeader, {
    closeable: closeable,
    title: title,
    onDismissClicked: onDismissClicked
  })) : null, /*#__PURE__*/React__default.createElement(Scrollable, null, /*#__PURE__*/React__default.createElement("div", {
...
const DropdownMenuGroup = _ref5 => {
  ...
  return /*#__PURE__*/React__default.createElement(RadixDropdownMenu.Group, {
    asChild: true
  }, /*#__PURE__*/React__default.createElement("div", {
...
const DropdownMenuItem = _ref6 => {
  ...
  return /*#__PURE__*/React__default.createElement(RadixDropdownMenu.Item, {
    disabled: disabled,
    onSelect: onSelect,
    asChild: true
  }, /*#__PURE__*/React__default.createElement("div", {
  ...
  }, icon)), /*#__PURE__*/React__default.createElement("span", null, text)), descraption && ( /*#__PURE__*/React__default.createElement("span", {
    className: `text-xs ${active ? "text-white text-opacity-70" : "text-secondary-text"}`
  }, descraption)), children && /*#__PURE__*/React__default.createElement("span", {
    className: "block"
  }, children)));
};
...
const DropdownDivider = () => ( /*#__PURE__*/React__default.createElement(RadixDropdownMenu.Separator, {
...
const HoverCard = _ref => {
  ...
  return /*#__PURE__*/React__default.createElement(RadixHoverCard.Root, {
    openDelay: delay
  }, children);
};
const HoverCardTrigger = _ref2 => {
  ...
  return /*#__PURE__*/React__default.createElement(RadixHoverCard.Trigger, {
    asChild: true
  }, children);
};
const HoverCardContent = _ref3 => {
  ...
  return /*#__PURE__*/React__default.createElement(RadixHoverCard.Portal, null, /*#__PURE__*/React__default.createElement(RadixHoverCard.Content, {
    side: side,
    align: align,
    alignOffset: alignOffset,
    sideOffset: sideOffset,
  ...
  }, props), children, /*#__PURE__*/React__default.createElement(RadixHoverCard.Arrow, {
...
const Popover = _ref => {
  ...
  return /*#__PURE__*/React__default.createElement(RadixPopover.Root, {
    modal: modal,
    open: isOpen,
    onOpenChange: onOpenChange
  }, children);
...
const PopoverTrigger = _ref2 => {
  ...
  return /*#__PURE__*/React__default.createElement(RadixPopover.Trigger, {
    asChild: true
  }, children);
};
const PopoverHeader = _ref3 => {
  ...
  }, title), /*#__PURE__*/React__default.createElement(RadixPopover.Close, {
    asChild: true,
    "aria-label": "Close"
  }, /*#__PURE__*/React__default.createElement(CloseButton$1, null)));
};
const PopoverContent = _ref4 => {
  ...
  return /*#__PURE__*/React__default.createElement(RadixPopover.Portal, null, /*#__PURE__*/React__default.createElement(RadixPopover.Content, {
    side: side,
    sideOffset: sideOffset,
    align: align,
    alignOffset: alignOffset,
  ...
  }, props), title ? /*#__PURE__*/React__default.createElement(PopoverHeader, {
    title: title
  }) : null, /*#__PURE__*/React__default.createElement(Scrollable, null, /*#__PURE__*/React__default.createElement("div", {
    className: "popover-content px-5 py-5"
  }, children)), /*#__PURE__*/React__default.createElement(RadixPopover.Arrow, {
    className: "fill-white"
  }))));
};
